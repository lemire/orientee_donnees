...
<div style="margin-left:1cm">
 <div style="background-color:#E0EAF0">
  ...
  .
        Parmi les affirmations suivantes, lesquelles s'appliquent à la norme
  <i>
   Dublin Core
  </i>
  ?
  ...
  <ol>
   ...
   <li>
    ...
    <span class="feedback" id="idp140346360255360false" style="display: none;font-weight:bold;">
     ...
     est souvent écrite en XML, mais n'a pas à l'être.
    </span>
   </li>
   <li>
...
<div style="margin-left:1cm">
 <div style="background-color:#E0EAF0">
  ...
  .
        Choisissez l'affirmation qui décrit le mieux l'information contenue dans
        ce document
  <i>
   Dublin Core
  </i>
  ...
  <p style="border:solid 1px black;white-space:pre; font-size:0.85em">
   &lt;?xml version="1.0" encoding="ISO-8859-1"?&gt;
            ...
            &lt;rdf:Description
            rdf:about="http://www.ledevoir.com/2004/09/30/65081.html"&gt;
            &lt;creator&gt;Alec Castonguay&lt;/creator&gt;
            &lt;title&gt;Harper est prêt pour de nouvelles
            élections&lt;/title&gt;
   ...
   <li>
    ...
    <span class="feedback" id="idp140346360266080false" style="display: none;font-weight:bold;">
     ...
     (Réponse incorrecte!) Non. On ne sait
                    pas quand l'article a été écrit : la date dans Dublin
                    Core n'a pas une
                    signification établie. La date pourrait plutôt être la date
                    de publication.
    </span>
   </li>
  </ol>
  ...
  <ol>
   ...
   <li>
    ...
    <span class="feedback" id="idp140346360272784false" style="display: none;font-weight:bold;">
     ...
     sert
                    surtout à décrire les droits associés à des
                    documents.
    </span>
   </li>
  </ol>
  <input class="button" onclick="javascript:var formid = 'idp140346360268272';var myform = document.getElementById(formid);var inputs = myform.getElementsByTagName('input'); for(inputscount = 0; inputscount &lt; inputs.length; ++inputscount){var spanel = document.getElementById(inputs[inputscount].value);if(inputs[inputscount].checked) {if(/true/.test(inputs[inputscount].value)) { spanel.style.color = &quot;blue&quot;;} else {spanel.style.color = &quot;red&quot;;}} else {if(/true/.test(inputs[inputscount].value)) { spanel.style.color = &quot;red&quot;;} else { spanel.style.color = &quot;blue&quot;;}}spanel.style.display=&quot;&quot;;}" type="button" value="Vérifier ma réponse"/>
  <input class="button" onclick="javascript:var formid = 'idp140346360268272';var myform = document.getElementById(formid);myform.reset();var inputs = myform.getElementsByTagName('input');for(inputscount = 0; inputscount &lt; inputs.length; ++inputscount){var spanel = document.getElementById(inputs[inputscount].value);spanel.style.display=&quot;none&quot;;}" type="button" value="Recommencer"/>
 </form>
</div>
<hr style="margin-bottom:1cm; margin-top:1cm;color: #0f0; background-color: #ccc; height: 5px;"/>
<div style="margin-left:1cm">
 <div style="background-color:#E0EAF0">
  ...
  <p style="border:solid 1px black;white-space:pre; font-size:0.85em">
   &lt;rdf:RDF xmlns="http://web.resource.org/cc/"
            ...
            &lt;Work rdf:about="http://www.mavieestbelle.com/index.html"&gt;
            &lt;license
            rdf:resource="http://creativecommons.org/licenses/by-nd/2.0/" /&gt;
            &lt;license
            rdf:resource="http://creativecommons.org/licenses/by-nc/2.0/" /&gt;
            &lt;/Work&gt;
            &lt;License
            rdf:about="http://creativecommons.org/licenses/by-nd/2.0/"&gt;
            ...
            &lt;/License&gt;
            &lt;License
            rdf:about="http://creativecommons.org/licenses/by-nc/2.0/"&gt;
            &lt;permits rdf:resource="http://web.resource.org/cc/Reproduction"
            /&gt;
            &lt;permits rdf:resource="http://web.resource.org/cc/Distribution"
            /&gt;
   ...
   <li>
    ...
    <span class="feedback" id="idp140346360278448false" style="display: none;font-weight:bold;">
     ...
     (Réponse incorrecte!) L'adresse
                    « http://www.mavieestbelle.com/index.html » doit
                    être traitée
                    comme un URI et non comme une URL; il pourrait ne pas y
                    avoir de document à cette adresse.
    </span>
   </li>
   <li>
...
<div style="margin-left:1cm">
 <div style="background-color:#E0EAF0">
  ...
  .
        Comment peut-on expliquer que le premier document
  <i>
   FOAF
  </i>
  en XML
        n'était pas du RDF valable?
 </div>
 <p style="width:90%;">
  Choisissez toutes les réponses qui s'appliquent, puis
        appuyez sur le bouton « Vérifier ma réponse ».
  ...
  <ol>
   ...
   <li>
    ...
    <span class="feedback" id="idp140346360285440false" style="display: none;font-weight:bold;">
     ...
     était une forme de RDF, mais on n'écrit plus le RDF de cette
                    façon.
    </span>
   </li>
   <li>
...
<div style="margin-left:1cm">
 ...
 <form id="idp140346360289168">
   ...
   <li>
    ...
    <span class="feedback" id="idp140346360292144true" style="display: none;font-weight:bold;">
     ...
     C'est vrai, même si l'exemple original
                    de Dan Brickley n'est pas du RDF/XML valable.
    </span>
   </li>
   <li>
    ...
    <span class="feedback" id="idp140346360293984false" style="display: none;font-weight:bold;">
     ...
     Au contraire, des milliers de portails
                    et des millions de sites web utilisent maintenant
     <i>
      RSS
     </i>
     .
  ...
  <input class="button" onclick="javascript:var formid = 'idp140346360289168';var myform = document.getElementById(formid);var inputs = myform.getElementsByTagName('input'); for(inputscount = 0; inputscount &lt; inputs.length; ++inputscount){var spanel = document.getElementById(inputs[inputscount].value);if(inputs[inputscount].checked) {if(/true/.test(inputs[inputscount].value)) { spanel.style.color = &quot;blue&quot;;} else {spanel.style.color = &quot;red&quot;;}} else {if(/true/.test(inputs[inputscount].value)) { spanel.style.color = &quot;red&quot;;} else { spanel.style.color = &quot;blue&quot;;}}spanel.style.display=&quot;&quot;;}" type="button" value="Vérifier ma réponse"/>
  <input class="button" onclick="javascript:var formid = 'idp140346360289168';var myform = document.getElementById(formid);myform.reset();var inputs = myform.getElementsByTagName('input');for(inputscount = 0; inputscount &lt; inputs.length; ++inputscount){var spanel = document.getElementById(inputs[inputscount].value);spanel.style.display=&quot;none&quot;;}" type="button" value="Recommencer"/>
 </form>
</div>
