...
D'un autre côté, la norme DTD est très répandue et tous les logiciels compatibles avec XML prennent maintenant en charge cette norme, incluant Java, Google Chrome et Firefox. Les formats comme XHTML 2.0 sont toujours publiés avec une spécification DTD. Les autres possibilités, comme XML Schema, Relax NG, Schematron et Examplotron, sont moins bien prises en charge.
...
La norme XML Schema est prise en charge en Java depuis la version 1.5. Il n'est pas nécessaire d'utiliser une bibliothèque spécialisée. Elle est cependant sujette à des critiques sévères de la part des experts en XML tels que Tim Bray (co-inventeur du XML) qui écrivait en novembre 2006 sur son blogue :
