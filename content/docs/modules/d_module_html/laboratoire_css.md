...
raison {
 ...
 <div style="background-color: #f9fafb; padding: 16px; border: 1px solid #e5e7eb; border-radius: 8px;">
  ...
  <textarea aria-label="Document XML source" cols="45" id="xmlsource" rows="25" style="width: 100%; padding: 8px; border: 1px solid #d1d5db; border-radius: 4px; font-family: monospace; font-size: 14px; margin-bottom: 16px;">&lt;?xml version="1.0" ?&gt;
&lt;comptearecevoir&gt;
    &lt;facture&gt;
        &lt;personne&gt;Jean Rochond&lt;/personne&gt;
        &lt;montant&gt;10.10&lt;/montant&gt;
...
&lt;/comptearecevoir&gt;
  ...
  <textarea aria-label="Feuille de style CSS" cols="45" id="csssource" rows="25" style="width: 100%; padding: 8px; border: 1px solid #d1d5db; border-radius: 4px; font-family: monospace; font-size: 14px; margin-bottom: 16px;">facture {
    display: block;
    margin-bottom: 30pt;
}
montant {
