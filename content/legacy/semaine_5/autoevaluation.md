...
<div class="">
 ...
 <div style="margin-left:1cm">
  <div style="background-color:#E0EAF0">
   ...
   .
		Quel énoncé décrit le mieux l'intention des créateurs du XML?
  </div>
  <p style="width:90%;">
 ...
 <div style="margin-left:1cm">
  <div style="background-color:#E0EAF0">
   ...
   .
		Parmi les affirmations suivantes, lesquelles s'appliquent au XML?
  </div>
  <p style="width:90%;">
  ...
  <form id="idp140650828097744">
   ...
   On utilise d'autres technologies, comme les technologies CSS ou XSLT pour la présentation.
     </span>
    </li>
    <li>
 ...
 [
 &lt;!ENTITY prenomduresponsable "Jean"&gt;
 &lt;!ENTITY nomduresponsable "Lachat"&gt;
 ]&gt;
 ...
 &lt;bookinfo&gt;
  ...
  &lt;author&gt;
   &lt;firstname&gt;&amp;prenomduresponsable;&lt;/firstname&gt;
   &lt;surname&gt;&amp;nomduresponsable;&lt;/surname&gt;
  &lt;/author&gt;
  &lt;copyright&gt;&lt;year&gt;2004&lt;/year&gt;&lt;holder&gt;&amp;prenomduresponsable;
   &amp;nomduresponsable;&lt;/holder&gt;&lt;/copyright&gt;
 &lt;/bookinfo&gt;

 &lt;chapter&gt;
 &lt;title&gt;Ceci est le premier chapitre de notre documentation.&lt;/title&gt; 
 &lt;para&gt;
 En cas de problème avec ce document, veuillez vous adresser à 
   &amp;prenomduresponsable; &amp;nomduresponsable;.&lt;/para&gt;
   &lt;para&gt;Pour l'instant, il n'y a rien d'autre dans le document.&lt;/para&gt;
 &lt;!-- Il faudrait bien que je me dépêche de terminer ce document. --&gt;
 &lt;/chapter&gt;
 &lt;/book&gt;
   </p>
  </div>
  ...
  <form id="idp140650828104288">
   <ol>
    ...
    <span class="feedback" id="idp140650828105760true" style="display: none;font-weight:bold;">
      ...
      si jamais on devait changer ce nom.
     </span>
    </li>
    <li>
   ...
   <input class="button" onclick="javascript:var formid = 'idp140650828104288';var myform = document.getElementById(formid);var inputs = myform.getElementsByTagName('input'); for(inputscount = 0; inputscount &lt; inputs.length; ++inputscount){var spanel = document.getElementById(inputs[inputscount].value);if(inputs[inputscount].checked) {if(/true/.test(inputs[inputscount].value)) { spanel.style.color = &quot;blue&quot;;} else {spanel.style.color = &quot;red&quot;;}} else {if(/true/.test(inputs[inputscount].value)) { spanel.style.color = &quot;red&quot;;} else { spanel.style.color = &quot;blue&quot;;}}spanel.style.display=&quot;&quot;;}" type="button" value="Vérifier ma réponse"/>
   <input class="button" onclick="javascript:var formid = 'idp140650828104288';var myform = document.getElementById(formid);myform.reset();var inputs = myform.getElementsByTagName('input');for(inputscount = 0; inputscount &lt; inputs.length; ++inputscount){var spanel = document.getElementById(inputs[inputscount].value);spanel.style.display=&quot;none&quot;;}" type="button" value="Recommencer"/>
  </form>
 </div>
 <hr style="margin-bottom:1cm; margin-top:1cm;color: #0f0; background-color: #ccc; height: 5px;"/>
 <div style="margin-left:1cm">
  <div style="background-color:#E0EAF0">
   ...
   .
		Qu'est-ce qui ne va pas avec le document DocBook suivant?
   <p style="border:solid 1px black;white-space:pre; font-size:0.85em">
    &lt;?xml version="1.0" encoding='ISO-8859-1' standalone="no"?&gt;
 &lt;!DOCTYPE book PUBLIC "-//OASIS//DTD DocBook XML V4.1.2//EN"
  "http://www.oasis-open.org/docbook/xml/4.1.2/docbookx.dtd"&gt;
...
déclaration de type, puisque l'élément-racine est de type « para » et non « book ».
     </span>
    </li>
    <li>
 ...
 <div style="margin-left:1cm">
  <div style="background-color:#E0EAF0">
   ...
   .
		Parmi les énoncés suivants, quels sont ceux qui s'appliquent au format DocBook?
  </div>
  <p style="width:90%;">
   Choisissez toutes les réponses qui s'appliquent, puis appuyez sur le bouton « Vérifier ma réponse ».
  </p>
...
qui ne sont pas du XML, mais du SGML.
     </span>
    </li>
   </ol>
   <input class="button" onclick="javascript:var formid = 'idp140650828118736';var myform = document.getElementById(formid);var inputs = myform.getElementsByTagName('input'); for(inputscount = 0; inputscount &lt; inputs.length; ++inputscount){var spanel = document.getElementById(inputs[inputscount].value);if(inputs[inputscount].checked) {if(/true/.test(inputs[inputscount].value)) { spanel.style.color = &quot;blue&quot;;} else {spanel.style.color = &quot;red&quot;;}} else {if(/true/.test(inputs[inputscount].value)) { spanel.style.color = &quot;red&quot;;} else { spanel.style.color = &quot;blue&quot;;}}spanel.style.display=&quot;&quot;;}" type="button" value="Vérifier ma réponse"/>
 ...
 <div style="margin-left:1cm">
  <div style="background-color:#E0EAF0">
   ...
   .
		Votre société décide d'utiliser le XML comme format d'échange pour ses
  listes de numéros de série; elle pourra ainsi utiliser les outils XML et
  assurer la pérennité des documents. L'ingénieur en charge propose deux formats possibles. 
  Quel format choisissez-vous? Dites pourquoi.
   <p style="border:solid 1px black;white-space:pre; font-size:0.85em">
    &lt;?xml version="1.0" encoding='ISO-8859-1'?&gt;
 &lt;liste&gt;
  &lt;numero_de_serie&gt;232-434&lt;/numero_de_serie&gt;
  &lt;numero_de_serie&gt;333-434&lt;/numero_de_serie&gt;
  &lt;numero_de_serie&gt;111-434&lt;/numero_de_serie&gt;
  &lt;numero_de_serie&gt;444-555&lt;/numero_de_serie&gt;
  &lt;/liste&gt;
   </p>
   <p style="border:solid 1px black;white-space:pre; font-size:0.85em">
    &lt;?xml version="1.0" encoding='ISO-8859-1'?&gt;
 &lt;liste&gt;232-434 333-434 111-434 444-555&lt;/liste&gt;
   </p>
  </div>
  <p style="width:90%;">
   Choisissez la bonne réponse parmi les suivantes.
...
le contenu; dans 10 ou 20 ans, on ne saura plus ce qui signifie tous ces numéros.
 ...
 <div style="margin-left:1cm">
  ...
  <form id="idp140650828133792">
   <ol>
    ...
    &lt;?xml-stylesheet href="docbook.xslt" type="application/xml"?&gt;
    &lt;book&gt;
    &lt;bookinfo&gt;
     &lt;title&gt;Notre documentation&lt;/title&gt;
 &lt;author&gt;
 ...
 &lt;/author&gt;
 &lt;copyright&gt;&lt;year&gt;2004&lt;/year&gt;&lt;holder&gt;UQ&lt;/holder&gt;&lt;/copyright&gt;
    &lt;/bookinfo&gt;
    &lt;chapter&gt;
     &lt;title&gt;Ceci est le premier chapitre de notre documentation.&lt;/title&gt;
 &lt;orderedlist&gt;
 &lt;listitem&gt; 
  &lt;para&gt;Ceci est le premier point&lt;/para&gt;
 &lt;/listitem&gt;
 &lt;listitem&gt;&lt;para&gt;Ceci est le second point&lt;/para&gt;
  &lt;para&gt;Ceci est le troisième point&lt;/para&gt;
 &lt;/listitem&gt;
 &lt;/orderedlist&gt;
    &lt;/chapter&gt;
    &lt;/book&gt;
...
contenir plusieurs éléments « para ».
 ...
 &lt;chapter&gt;
      &lt;title&gt;Ceci est le premier chapitre de notre documentation.&lt;/title&gt;
  &lt;para&gt;Voici un exemple de code Java:&lt;/para&gt;
  &lt;para&gt;&lt;programlisting&gt;
...
en premier dans un élément « chapter », et non pas en dernier.
 ...
 &lt;para&gt;Voici un exemple de code Java:&lt;/para&gt;
        &lt;para&gt;&lt;programlisting&gt;
 public static void main(String[] arg) {
 if(arg.length&lt;1) System.out.println("Vous devez mettre un argument.");
 }
 &lt;/programlisting&gt;&lt;/para&gt;
  &lt;/chapter&gt;
  &lt;/book&gt;
     </p>
     <span class="feedback" id="idp140650828140128false" style="display: none;font-weight:bold;">
      <br/>
      Le document n'est pas bien formé : le code Java contient un symbole &lt; : 
il aurait fallu utiliser l'entité « &amp;lt; ».
     </span>
    </li>
    <li>
 ...
 &lt;copyright&gt;&lt;year&gt;2004&lt;/year&gt;&lt;holder&gt;UQ&lt;/holder&gt;&lt;/copyright&gt;
  ...
  &lt;chapter&gt;
    &lt;title&gt;Ceci est le premier chapitre de notre documentation.&lt;/title&gt;
 &lt;orderedlist&gt;
 &lt;listitem&gt;Ceci est le premier point&lt;/listitem&gt;
 &lt;listitem&gt;Ceci est le second point&lt;/listitem&gt;
 &lt;/orderedlist&gt;
    &lt;/chapter&gt;
    &lt;/book&gt;
     </p>
...
du texte directement dans un élément « listitem », il faut utiliser un élément « para ».
   ...
   <input class="button" onclick="javascript:var formid = 'idp140650828133792';var myform = document.getElementById(formid);var inputs = myform.getElementsByTagName('input'); for(inputscount = 0; inputscount &lt; inputs.length; ++inputscount){var spanel = document.getElementById(inputs[inputscount].value);if(inputs[inputscount].checked) {if(/true/.test(inputs[inputscount].value)) { spanel.style.color = &quot;blue&quot;;} else {spanel.style.color = &quot;red&quot;;}} else {if(/true/.test(inputs[inputscount].value)) { spanel.style.color = &quot;red&quot;;} else { spanel.style.color = &quot;blue&quot;;}}spanel.style.display=&quot;&quot;;}" type="button" value="Vérifier ma réponse"/>
   <input class="button" onclick="javascript:var formid = 'idp140650828133792';var myform = document.getElementById(formid);myform.reset();var inputs = myform.getElementsByTagName('input');for(inputscount = 0; inputscount &lt; inputs.length; ++inputscount){var spanel = document.getElementById(inputs[inputscount].value);spanel.style.display=&quot;none&quot;;}" type="button" value="Recommencer"/>
  </form>
 </div>
 <hr/>
</div>
